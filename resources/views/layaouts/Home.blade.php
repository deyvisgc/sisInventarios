...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css1/owl.carousel.css')}}"/>
...
<header class="header-section">
    <div class="container">
        ...
        <!-- logo -->
        <a href="index.html" class="site-logo"><img src="{{asset('Imagenes/logo.png')}}" alt=""></a>
...
<nav class="nav-section">
    <div class="container">
        <div class="nav-right">
            <a href="{{route('profile')}}"><i class="glyphicon glyphicon-log-in"> Login</i></a>
...
<section class="hero-section">
    <div class="hero-slider owl-carousel">
        <div class="hs-item set-bg" data-setbg="{{asset('Imagenes/hero-slider/1.jpg')}}">
            <div class="hs-text">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
        ...
        <div class="hs-item set-bg" data-setbg="{{asset('Imagenes/hero-slider/2.jpg')}}">
            <div class="hs-text">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6 service-item">
                <div class="service-icon">
                    <img src="{{asset('Imagenes/services-icons/1.png')}}" alt="1">
                </div>
            ...
            <div class="col-lg-4 col-sm-6 service-item">
                <div class="service-icon">
                    <img src="{{asset('Imagenes/services-icons/2.png')}}" alt="1">
                </div>
                <div class="service-content">
            ...
            <div class="col-lg-4 col-sm-6 service-item">
                <div class="service-icon">
                    <img src="{{asset('Imagenes/services-icons/3.png')}}" alt="1">
                </div>
                <div class="service-content">
                    <h4>Activity Hub</h4>
                    <p>Lorem ipsum dolor sitdo amet, consectetur dont adipis elit. Vivamus interdum ultrices augue. Aenean dos cursus lania.</p>
            ...
            <div class="col-lg-4 col-sm-6 service-item">
                <div class="service-icon">
                    <img src="{{asset('Imagenes/services-icons/4.png')}}" alt="1">
                </div>
                <div class="service-content">
            ...
            <div class="col-lg-4 col-sm-6 service-item">
                <div class="service-icon">
                    <img src="{{asset('Imagenes/services-icons/5.png')}}" alt="1">
                </div>
                <div class="service-content">
            ...
            <div class="col-lg-4 col-sm-6 service-item">
                <div class="service-icon">
                    <img src="{{asset('Imagenes/services-icons/6.png')}}" alt="1">
                </div>
                <div class="service-content">
                    <h4>Chemistry Lab</h4>
                    <p>Lorem ipsum dolor sitdo amet, consectetur dont adipis elit. Vivamus interdum ultrices augue. Aenean dos cursus lania.</p>
...
<!-- Enroll section -->
<section class="enroll-section spad set-bg" data-setbg="{{asset('Imagenes/enroll-bg.jpg')}}">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
            ...
            <div class="col-lg-6 offset-lg-1 p-lg-0 p-4">
                <img src="{{asset('Imagenes/encroll-img.jpg')}}" alt="">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 course-item">
                <div class="course-thumb">
                    <img src="{{asset('Imagenes/course/1.jpg')}}" alt="">
            ...
            <div class="col-lg-4 col-md-6 course-item">
                <div class="course-thumb">
                    <img src="{{asset('Imagenes/course/2.jpg')}}" alt="">
                    <div class="course-cat">
                        <span>Marketing</span>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 course-item">
                <div class="course-thumb">
                    <img src="{{asset('Imagenes/course/3.jpg')}}" alt="">
                    <div class="course-cat">
                        <span>DESIGN</span>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 course-item">
                <div class="course-thumb">
                    <img src="{{asset('Imagenes/course/4.jpg')}}" alt="">
                    <div class="course-cat">
                        <span>DATABASE</span>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 course-item">
                <div class="course-thumb">
                    <img src="{{asset('Imagenes/course/5.jpg')}}" alt="">
                    <div class="course-cat">
                        <span>PROGRAM</span>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 course-item">
                <div class="course-thumb">
                    <img src="{{asset('Imagenes/course/6.jpg')}}" alt="">
                    <div class="course-cat">
                        <span>BUSINESS</span>
                    </div>
                </div>
...
<!-- Fact section -->
<section class="fact-section spad set-bg" data-setbg="{{asset('Imagenes/fact-bg.jpg')}}">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-6 event-item">
                <div class="event-thumb">
                    <img src="{{asset('Imagenes/event/1.jpg')}}" alt="">
            ...
            <div class="col-md-6 event-item">
                <div class="event-thumb">
                    <img src="{{asset('Imagenes/event/2.jpg')}}" alt="">
                    <div class="event-date">
...
<div class="gallery-section">
    <div class="gallery">
        ...
        <div class="gallery-item gi-big set-bg" data-setbg="{{asset('Imagenes/gallery/1.jpg')}}">
            <a class="img-popup" href="{{asset('Imagenes/gallery/1.jpg')}}"><i class="ti-plus"></i></a>
        </div>
        <div class="gallery-item set-bg" data-setbg="{{asset('Imagenes/gallery/2.jpg')}}">
            <a class="img-popup" href="{{asset('Imagenes/gallery/2.jpg')}}"><i class="ti-plus"></i></a>
        </div>
        <div class="gallery-item set-bg" data-setbg="{{asset('Imagenes/gallery/3.jpg')}}">
            <a class="img-popup" href="{{asset('Imagenes/gallery/3.jpg')}}"><i class="ti-plus"></i></a>
        </div>
        <div class="gallery-item gi-long set-bg" data-setbg="{{asset('Imagenes/gallery/5.jpg')}}">
            <a class="img-popup" href="{{asset('Imagenes/gallery/5.jpg')}}"><i class="ti-plus"></i></a>
        </div>
        <div class="gallery-item gi-big set-bg" data-setbg="{{asset('Imagenes/gallery/8.jpg')}}">
            <a class="img-popup" href="{{asset('Imagenes/gallery/8.jpg')}}"><i class="ti-plus"></i></a>
        </div>
        <div class="gallery-item gi-long set-bg" data-setbg="{{asset('Imagenes/gallery/4.jpg')}}">
            <a class="img-popup" href="{{asset('Imagenes/gallery/4.jpg')}}"><i class="ti-plus"></i></a>
        </div>
        <div class="gallery-item set-bg" data-setbg="{{asset('Imagenes/gallery/6.jpg')}}">
            <a class="img-popup" href="{{asset('Imagenes/gallery/6.jpg')}}"><i class="ti-plus"></i></a>
        </div>
        <div class="gallery-item set-bg" data-setbg="{{asset('Imagenes/gallery/7.jpg')}}">
            <a class="img-popup" href="{{asset('Imagenes/gallery/7.jpg')}}"><i class="ti-plus"></i></a>
        </div>
    </div>
</div>
<!-- Gallery section -->
...
<section class="blog-section spad">
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="blog-item">
                    <div class="blog-thumb set-bg" data-setbg="{{asset('Imagenes/blog/1.jpg')}}"></div>
            ...
            <div class="col-xl-6">
                <div class="blog-item">
                    <div class="blog-thumb set-bg" data-setbg="{{asset('Imagenes/blog/2.jpg')}}"></div>
                    <div class="blog-content">
            ...
            <div class="col-xl-6">
                <div class="blog-item">
                    <div class="blog-thumb set-bg" data-setbg="{{asset('Imagenes/blog/3.jpg')}}"></div>
                    <div class="blog-content">
            ...
            <div class="col-xl-6">
                <div class="blog-item">
                    <div class="blog-thumb set-bg" data-setbg="{{asset('Imagenes/blog/4.jpg')}}"></div>
                    <div class="blog-content">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 footer-widget">
                <div class="about-widget">
                    <img src="{{asset('Imagenes/logo-light.png')}}" alt="">
...
<script src="{{asset('js1/jquery.countdown.js')}}"></script>
<script src="{{asset('js1/masonry.pkgd.min.js')}}"></script>
<script src="{{asset('js1/magnific-popup.min.js')}}"></script>
